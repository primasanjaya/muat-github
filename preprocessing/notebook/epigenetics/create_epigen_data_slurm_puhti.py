...
if __name__ == '__main__':
    ...
    #requirements:
    metadata = pd.read_csv('/users/primasan/projects/muat/extfile/metadata_icgc_pcawg.tsv',sep='\t',index_col=0) 
    dictMutation = pd.read_csv('/users/primasan/projects/muat/extfile/dictMutation.csv',index_col=0)
    dictChpos = pd.read_csv('/users/primasan/projects/muat/extfile/dictChpos.csv',index_col=0)
    dictGES = pd.read_csv('/users/primasan/projects/muat/extfile/dictGES.csv',index_col=0)

    epigene = pd.read_csv('/scratch/project_2001668/data/pcawg/allclasses/epigenetic_token.tsv',sep='\t')
    epigene = epigene.drop(columns=['Unnamed: 0'])

    pcawg_dir = '/scratch/project_2001668/data/pcawg/allclasses/simplified_data/'
    tokenized_data = '/scratch/project_2001668/data/pcawg/allclasses/tokenized_data/'
